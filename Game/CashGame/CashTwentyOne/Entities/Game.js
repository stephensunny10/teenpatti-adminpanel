class Game {
    constructor(id, roomId, status, pot,players,winners,losers,history, gameNumber,type, gameType, jokerCard, upperJoker, lowerJoker, openDeck, closeDeck, finishDeck,declare ) {
        this.id             = id;
        this.roomId         = roomId;
