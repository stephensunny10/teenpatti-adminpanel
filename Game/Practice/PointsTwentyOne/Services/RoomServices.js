...
module.exports = {
    ...
    create: async function(data){
        ...
        try {
            let tableCount = await roomModel.countDocuments({'gameType': 'practice_points21'});
            ...
            // room.id = room._id
            if(room){
                Sys.Rooms[room.id] = new Sys.Game.Practice.PointsTwentyOne.Entities.Room().createObject(room);
