...
module.exports = {
    ...
    create: async function(data){
        ...
        try {
            let tableCount = await roomModel.countDocuments({'gameType': 'practice_points24'});
            ...
            // room.id = room._id
            if(room){
                Sys.Rooms[room.id] = new Sys.Game.Practice.PointsTwentyFour.Entities.Room().createObject(room);
