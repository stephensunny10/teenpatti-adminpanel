...
module.exports = { 
    ...
    create: async function(data){
        ...
        try {
			...
			let game =  new Sys.Game.Practice.Pool.Entities.Game(null,gameObj.roomId,gameObj.status, gameObj.pot, gameObj.history, gameObj.gameNumber, gameObj.gameType, gameObj.jokerCard, gameObj.openDeck, gameObj.closeDeck, gameObj.finishDeck, gameObj.declare);
            ...
            if(game){
                    ...
                    return new Sys.Game.Practice.Pool.Entities.Game(game.id,game.roomId,game.status, game.pot, game.history, game.gameNumber, game.gameType, game.jokerCard, game.openDeck, game.closeDeck, game.finishDeck, game.declare); // return Room 
